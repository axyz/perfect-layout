...
"use strict";function BreakpointPartition(t,r){if(t.length<=1)return[t];if(r>=t.length)return t.map(function(t){return[t]});var n=findLayoutWidth(t,r),e=0;return t.reduce(function(t,r){return sum(t[e])+r>n&&e++,t[e].push(r),t},new Array(r).join().split(",").map(function(){return[]}))}function findLayoutWidth(t,r){for(var n=sum(t)/r,e=max(t),o=(max([n,e]),getLayoutDetails(t,layoutWidth));o.rowCount>rowCount;)layoutWidth+=o.nextBreakpoint,o=getLayoutDetails(t,layoutWidth);return layoutWidth}function getLayoutDetails(t,r){var n={currentRowWidth:0,rowCount:1,nextBreakpoint:Math.min.apply(null,t)};t.reduce(function(t,n){var e=t.currentRowWidth+n;return e>r&&(nextBreakpointForCurrentRow=t.currentRowWidth-r,nextBreakpointForCurrentRow<t.nextBreakpoint&&(t.nextBreakpoint=nextBreakpointForCurrentRow),t.rowCount+=1,t.currentRowWidth=n),t},n);return{rowCount:layout.rowCount,nextBreakpoint:layout.nextBreakpoint}}function sum(t){return t.reduce(function(t,r){return t+r},0)}function max(t){return t.reduce(function(t,r){return r>t?r:t},0)}Object.defineProperty(exports,"__esModule",{value:!0}),exports["default"]=BreakpointPartition,module.exports=exports["default"];
